...
<div class="auth-container">
    <div class="auth-card text-center" style="max-width: 600px;">
        ...
        <div style="display: grid; grid-template-cols: 1fr 1fr; gap: 1.5rem; margin-bottom: 3rem;">
            <a href="{{ $waUrl }}" target="_blank" style="text-decoration: none; display: block;">
                <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 1.5rem; padding: 2rem; transition: all 0.3s; height: 100%;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='var(--border)'; this.style.transform='translateY(0)'">
                    <div style="width: 48px; height: 48px; background: #22c55e; border-radius: 1rem; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem;">
                    ...
                    <h3 style="color: white; font-weight: 800; font-size: 1rem; margin-bottom: 0.5rem;">Kirim ke WhatsApp</h3>
                    <p style="color: var(--text-muted); font-size: 0.75rem;">Konfirmasi manual ke Admin</p>
                </div>
            </a>

            <a href="{{ $gformUrl }}" target="_blank" style="text-decoration: none; display: block;">
                <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border); border-radius: 1.5rem; padding: 2rem; transition: all 0.3s; height: 100%;" onmouseover="this.style.borderColor='var(--primary)'; this.style.transform='translateY(-5px)'" onmouseout="this.style.borderColor='var(--border)'; this.style.transform='translateY(0)'">
                    <div style="width: 48px; height: 48px; background: var(--primary); border-radius: 1rem; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem;">
                    ...
                    <h3 style="color: white; font-weight: 800; font-size: 1rem; margin-bottom: 0.5rem;">Isi Google Form</h3>
                    <p style="color: var(--text-muted); font-size: 0.75rem;">Lengkapi data tambahan</p>
                </div>
            </a>
        </div>

        <a href="{{ route('home') }}" class="btn btn-outline" style="width: 100%; padding: 1rem;">Kembali ke Beranda</a>
    </div>
</div>
