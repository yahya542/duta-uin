        ...
        <div style="display: grid; grid-template-cols: 1fr 2fr; gap: 2rem; align-items: start;">
            ...
            <div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    <a href="{{ route('admin.candidates.index') }}" class="btn btn-outline" style="justify-content: space-between; padding: 1.5rem; border-radius: 1.25rem; background: rgba(0,0,0,0.02);">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <span style="font-weight: 700; color: var(--text-main);">Kelola Kandidat</span>
                        </div>
                        <span style="color: var(--primary);">→</span>
                    </a>

                    <a href="{{ route('admin.transactions.index') }}" class="btn btn-outline" style="justify-content: space-between; padding: 1.5rem; border-radius: 1.25rem; background: rgba(0,0,0,0.02);">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            <div style="width: 40px; height: 40px; background: rgba(59, 130, 246, 0.1); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--primary);">
                            ...
                            <span style="font-weight: 700; color: var(--text-main);">Verifikasi Transaksi</span>
                        </div>
                        <span style="color: var(--primary);">→</span>
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach($recentTransactions as $tx)
                                <tr>
                                    ...
                                    <td style="text-align: right; font-weight: 800; color: var(--text-main); font-size: 0.875rem;">Rp {{ number_format($tx->nominal, 0, ',', '.') }}</td>
